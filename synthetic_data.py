...
def main():
    ...
    for transformation in data_transforms.keys():
        ...
        data_transform = data_transforms[transformation]
        ...
        for idx, (inputs, targets) in enumerate(train_loader):
            ...
            img_path = images_path / '{}_{}.JPEG'.format(class_name, class_counter)
            torchvision.utils.save_image(inputs[0], img_path)

...
#CUDA_VISIBLE_DEVICES=0 python train.py --data 10 res --logfile tin-base
#CUDA_VISIBLE_DEVICES=0 python train.py --data 10 res --logfile tin-jitter --transforms jitter
#CUDA_VISIBLE_DEVICES=0 python train.py --data 10 res --logfile tin-rotate --transforms rotateWithin45
CUDA_VISIBLE_DEVICES=1 python train.py --data 10 res --logfile tin-shear --transforms shear
CUDA_VISIBLE_DEVICES=1 python train.py --data 10 res --logfile tin-flip --transforms flip
